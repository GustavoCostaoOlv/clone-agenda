  ...
  <div class="text-center mb-8">
    <h1 class="text-4xl font-bold text-white">
      <a href="#" class="hover:text-primarylight transition-colors">
        <span class="text-primarylight">Cursos</span> <span class="text-white">Online</span> 
      </a>
    </h1>
    ...
    <div class="p-8">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <input type="file" name="foto" id="foto"
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primarylight file:text-primary hover:file:bg-[#dfe5ea]"
      ...
      <div class="text-center mt-8 pt-6 border-t border-gray-200">
        <p class="text-gray-600">
          Já tem uma conta?
          <a href="index.php" class="text-primary hover:text-primarydark font-semibold transition-colors ml-1">
            Faça login aqui!
          </a>
        </p>
      </div>
